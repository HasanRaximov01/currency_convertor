...
class _$_Data implements _Data {
  ...
  @override
  String toString() {
    return 'Data(id: $id, code: $code, ccy: $ccy, ccyNmRU: $ccyNmRU, ccyNmUZ: $ccyNmUZ, ccyNmUZC: $ccyNmUZC, ccyNmEN: $ccyNmEN, nominal: $nominal, rate: $rate, diff: $diff, date: $date)';
  }
...
abstract class _Data implements Data {
  const factory _Data(
      ...
      required final String ccyNmRU,
      required final String ccyNmUZ,
      required final String ccyNmUZC,
      required final String ccyNmEN,
      required final String nominal,
      required final String rate,
      required final String diff,
      required final String date}) = _$_Data;
